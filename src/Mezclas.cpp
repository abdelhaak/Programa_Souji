...
void Mezclas::mezclaVacio()
{
  ...
  if (PesoActual() <= pesoMinimo)
  {
    ...
    Serial.println("Peso actual ya está por debajo del mínimo, no se necesita vaciar más.");
    return;
  }
  bombaVacio.on();
...
{
  Serial.println("Estamos en hecharLiquido");
  Serial.print("enPausa : ");
  Serial.println(enPausa);
  ...
  Serial.println("Estamos despues de hecharliquido");
  Serial.print("enPausa : ");
  Serial.println(enPausa);
  enPausa = false;
...
{
  Serial.println("Estamos en pausarReanudarMezcla");
  Serial.print("enPausa : ");
  Serial.println(enPausa);
  enPausa = !enPausa;
  if (enPausa)
...
{
  Serial.println("Estamos en esperarParaReanudar");
  Serial.print("enPausa : ");
  Serial.println(enPausa);
  while (enPausa)
  {
